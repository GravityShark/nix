...

{
  ...
  config = lib.mkIf config.desktop.mango.enable {
    ...
    wayland.windowManager.mango = {
      ...
      #
      #   # menu and terminal
      #   # https://github.com/DreamMaoMao/mangowc/issues/318 they don't even allow this to work :sob:
      #   # bind=SUPER,code:133,spawn,wmenu-run -l 10
      #   bind=SUPER,grave,spawn,wmenu-run -l 10
      #   bind=SUPER,t,spawn,ghostty
      #   bind=SUPER+SHIFT,t,spawn,uwsm app -- com.mitchellh.ghostty.desktop
      ...
      #   bind=SUPER,Prior,viewtoleft_have_client,0
      #   # bind=SUPER,Right,viewtoright,0
      #   bind=SUPER,Next,viewtoright_have_client,0
      #   # bind=SHIFT+SUPER,PageUp,tagtoleft,0
      #   # bind=SHIFT+SUPER,PageDown,tagtoright,0
      #
