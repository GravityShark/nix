...
{
  options = {
    service.emacs.enable = lib.mkEnableOption "enables the emacs server and also brigns all required shit for emacs to work. also means you can run emacs rn if you enable this";
  };

  config = lib.mkIf config.service.emacs.enable {
